...
-(instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
    ...
    if (self) {
        UILabel * label = [[UILabel alloc] initWithFrame:CGRectMake(8, 0, screenWide/4, screenHeight * 0.06)];
        label.font = [UIFont systemFontOfSize:12];
        label.textColor = RGB(106, 106, 106);
        _title_label = label;
        [self addSubview:_title_label];
        UITextField * field = [[UITextField alloc] initWithFrame:CGRectMake(8+screenWide /4, 0, screenWide - 46 , screenHeight * 0.06)];

             ...
             reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self)
    {
        ...
        UICollectionView * season_collectionView = [[UICollectionView alloc]
                                                 initWithFrame:CGRectMake(0, screenHeight * 0.013,screenWide, screenHeight * 0.253) collectionViewLayout:layout];
        ...
        UIPageControl * carousePageControl = [[UIPageControl alloc]
                                              initWithFrame:CGRectMake(wides /4.0 , screenHeight * 0.253 - kMargin/2, wides /2.0, kMargin)];

             ...
             reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self)
    {
        ...
        UIView * view = [[UIView alloc]
                         initWithFrame:CGRectMake(screenHeight * 0.02, screenHeight * 0.02, screenWide - screenHeight * 0.04, screenHeight * 0.17)];
        view.backgroundColor = RGB(255, 253, 228);
        [self addSubview:view];
        UIImageView * no_use_imageView = [[UIImageView alloc]
                                          initWithFrame:CGRectMake(0, 0,screenHeight * 0.06, screenHeight * 0.06)];
        no_use_imageView.image = [UIImage imageNamed:@"weishiyong_"];
        [view addSubview:no_use_imageView];
        UILabel * rmb_label = [[UILabel alloc]
                               initWithFrame:CGRectMake(screenWide * 0.2, screenHeight * 0.05, screenWide * 0.065, screenHeight * 0.06)];
        rmb_label.text = @"¥";
        ...
        money_label = [[UILabel alloc]
                       initWithFrame:CGRectMake(screenWide * 0.28, screenHeight * 0.01, screenWide * 0.3, screenHeight * 0.1)];
        ...
        moneyuse_label = [[UILabel alloc]
                          initWithFrame:CGRectMake(screenWide * 0.2, screenHeight * 0.12, screenWide * 0.4, screenHeight * 0.03)];
        ...
        UIImageView * red_imageView =[[UIImageView alloc]
                                      initWithFrame:CGRectMake(screenWide * 0.66, 0, screenWide * 0.35 - screenHeight * 0.04, screenHeight * 0.17)];
        red_imageView.image = [UIImage imageNamed:@"system_08"];
        [view addSubview:red_imageView];
        UILabel * label1 = [[UILabel alloc]
                            initWithFrame:CGRectMake(screenWide * 0.05, screenHeight * 0.03, screenWide * 0.25, screenHeight * 0.03)];
        label1.textColor = RGB(255, 253, 228);
        label1.text = @"有效期";
        label1.font = [UIFont systemFontOfSize:13];
        [red_imageView addSubview:label1];
        timeFrom_label = [[UILabel alloc]
                          initWithFrame:CGRectMake(screenWide * 0.05, screenHeight * 0.06, screenWide * 0.25, screenHeight * 0.03)];
        ...
        UILabel * label2 = [[UILabel alloc]
                            initWithFrame:CGRectMake(screenWide * 0.05, screenHeight * 0.09, screenWide * 0.25, screenHeight * 0.03)];
        label2.textColor = RGB(255, 253, 228);
        label2.text = @"至";
        label2.font = [UIFont systemFontOfSize:13];
        [red_imageView addSubview:label2];
        timeTo_label =  [[UILabel alloc]
                         initWithFrame:CGRectMake(screenWide * 0.05, screenHeight * 0.12, screenWide * 0.25, screenHeight * 0.03)];
...
- (void)configWithMoneystr:(NSString *)money
                       use:(NSString *)use
                     timeF:(NSString *)timeF
                     timeT:(NSString *)timeT
{
    if (money)
    {

...
-(void)configOrderWithtitle:(NSString *)title image:(UIImage *)image type:(NSInteger)type price:(NSString *)price {
    if (self) {
        ...
        if (type == 1) {
            ...
            [self.first_btn setTitle:@"取消订单" forState:UIControlStateNormal];
            [self.second_btn setTitle:@"付款" forState:UIControlStateNormal];
            ...
            [self.first_btn setTitle:@"取消订单" forState:UIControlStateNormal];
            [self.second_btn setTitle:@"使用" forState:UIControlStateNormal];
            self.serve_label.text = @"自理｜单人间朝南｜包餐";
            self.organAddress_label.text = @"地址：杭州市滨江区江晖路隆和国际603fsgsdkyarhkgadgdshgfjzdhgfzdhj";
        }else if (type == 3) {
            self.type_label.text = @"待评价";
            [self.first_btn setTitle:@"取消订单" forState:UIControlStateNormal];
            [self.second_btn setTitle:@"评价" forState:UIControlStateNormal];
            self.serve_label.text = @"自理｜单人间朝南｜包餐";
            self.organAddress_label.text = @"地址：杭州市滨江区江晖路隆和国际603fsgsdkyarhkgadgdshgfjzdhgfzdhj";
        }
...
-(void)configRefundWithtitle:(NSString *)title image:(UIImage *)image type:(NSInteger)type price:(NSString *)price {
    if (self) {
        ...
        if (type == 1) {
            ...
            [self.first_btn setTitle:@"查看订单" forState:UIControlStateNormal];
            [self.second_btn setTitle:@"取消付款" forState:UIControlStateNormal];
            self.serve_label.text = @"自理｜单人间朝南｜包餐";
            self.organAddress_label.text = @"地址：杭州市滨江区江晖路隆和国际603fsgsdkyarhkgadgdshgfjzdhgfzdhj";
        }else if (type == 2) {
            self.type_label.text = @"已退款";
            [self.first_btn setTitle:@"查看订单" forState:UIControlStateNormal];
            [self.second_btn setTitle:@"删除订单" forState:UIControlStateNormal];
            self.serve_label.text = @"自理｜单人间朝南｜包餐";
            self.organAddress_label.text = @"地址：杭州市滨江区江晖路隆和国际603fsgsdkyarhkgadgdshgfjzdhgfzdhj";
        }
        if (price) {

...
#define APP_ID          @"wx37532d8c612b2c3f"               //APPID
#define APP_SECRET      @"bc02c1fcf08d927e38e348e6286beea9" //appsecret
//商户号，填写商户对应参数
#define MCH_ID          @"1328628101"
//商户API密钥，填写相应参数
#define PARTNER_ID      @"linlicccmtv2016YanKaiWangjuanAnd"
//支付结果回调页面
